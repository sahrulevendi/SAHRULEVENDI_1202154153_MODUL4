package com.sinauyo.sahrulevendi_1202154153_modul4;
...
public class ListNama extends AppCompatActivity {
    ...
    private String[] mahasiswaArray = {
            "Sahrul Evendi", "Amalia", "Syahril May Mubdi", "Linda Wulandari", "Amelia Rahmadani", "Butet", "Ucok", "Siregar", "Sipahutar"
            , "Simatupang", "Sinaga", "Siantar"};
